...
import { FaqList } from '~/components/features/home/faq/list';
        ...
        <section className="overflow-hidden pb-20 lg:pb-25 xl:pb-30">
            <div className="relative mx-auto max-w-c-1235 px-4 md:px-8 xl:px-0">
                ...
                <div className="flex flex-wrap gap-8 md:flex-nowrap md:items-center xl:gap-32.5">
                    <Reveal dir="left" className="animate_left md:w-2/5 lg:w-1/2">
                    ...
                    <Reveal dir="right" className="animate_right md:w-3/5 lg:w-1/2">
                        <FaqList />
                    </Reveal>
                </div>
            </div>
